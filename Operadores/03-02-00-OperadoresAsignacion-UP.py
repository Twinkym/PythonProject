...
# Asignación multiple. Crear multiples variables en una sola linea
...
# Puedes solicitar al usuario que ingrese varios datos a la vez,
# separados por comas, y usar la asignación múltiple para
# obtener estos datos.
